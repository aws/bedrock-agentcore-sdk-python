...
| opentelemetry_langchain_spans.json | AgentCoreEvaluationOpenTelemetryMapper `test/resources/agentcore_observability_logs/opentelemetry_instrumentation_langchain/adot_native_instrumentation/adot_v18_langgraph_travel_1_turn.json` | LangGraph travel agent, Amazon OpenTelemetry Distro instrumentation (adot v18, single turn with tool call) |
