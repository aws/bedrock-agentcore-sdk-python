"""Tests for IntentProvider and DefaultIntentProvider."""
...
class TestDefaultIntentProvider:
    """Test DefaultIntentProvider class."""
    ...
    @patch(
        "bedrock_agentcore.gateway.integrations.strands.plugins.agentcore_tool_search.intent_providers.default_intent_provider.Agent"
    )
    ...
    def test_derive_intent_uses_explicit_model(self, mock_agent_class):
        ...
        provider = DefaultIntentProvider(model=explicit_model)
    ...
    def test_derive_intent_respects_message_window(self, mock_agent_class):
        ...
        # The formatted prompt should only contain the last 2 messages
    ...
    def test_format_messages_for_prompt(self):
        """Test message formatting for the LLM prompt."""
        provider = DefaultIntentProvider()
        messages = [
    ...
    def test_format_messages_handles_missing_role(self):
        """Test formatting handles messages without role."""
        provider = DefaultIntentProvider()
