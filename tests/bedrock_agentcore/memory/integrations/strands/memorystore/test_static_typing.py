...
def test_memorystore_package_types_compose_with_memory_manager() -> None:
    """Documented canonical imports retain precise types and factory lists remain composable."""
