"""Tests for the sender's private AgentCore message-formatting helpers."""
...
map_role = AgentCoreEventSender._map_role
extract_text = AgentCoreEventSender._extract_text
is_user_or_assistant_with_text = AgentCoreEventSender._is_user_or_assistant_with_text
