...
from bedrock_agentcore.memory.integrations.strands.factory import (
...
def test_namespace_validation_matches_ecmascript_trim_boundaries() -> None:
    """Accept U+0085 as namespace content and reject a BOM-only namespace."""
...
def test_factory_preserves_explicit_falsey_client(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from bedrock_agentcore.memory.integrations.strands import factory as factory_module
