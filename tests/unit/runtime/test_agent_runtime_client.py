...
from bedrock_agentcore.runtime.agent_runtime_client import AgentRuntimeClient
...
class TestBuildWebsocketUrl:
    ...
    @patch("bedrock_agentcore.runtime.agent_runtime_client.get_data_plane_endpoint")
...
class TestGenerateWsConnection:
    ...
    @patch("bedrock_agentcore.runtime.agent_runtime_client.boto3.Session")
    @patch("bedrock_agentcore.runtime.agent_runtime_client.get_data_plane_endpoint")
